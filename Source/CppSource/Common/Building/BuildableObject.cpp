...
void from_json(const nlohmann::json& j, ItemSetup& p) { j.at("Higherarch").get_to(p.Higherarch); }

std::map<Entity, EntityData*> BuildableObject::GenerateObjectCopy() { return EntityLoader::LoadTemplateToNewEntities(itemTemplate); }
