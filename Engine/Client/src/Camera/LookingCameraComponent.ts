...
export class LookingCameraComponent {
    ...
    UpdateLook() {
        ...
        this.DesiredRotationChange.x = (this.ecosystem.InputValues.mouseX / width) * -rotSpeed;
        this.DesiredRotationChange.y = (this.ecosystem.InputValues.mouseY / height) * rotSpeed;
        ...
        if (panning && active) {
            this.rotationViewOffset.y += this.ecosystem.InputValues.mouseX * rotSpeed * this.panSpeed;
            this.rotationViewOffset.x += this.ecosystem.InputValues.mouseY * rotSpeed * this.panSpeed;
        }
