//Physics may be compiled out!
let PhysicsCollider: any;
import("../Autogenerated/babylonburst_ServerTypings_autogenerated").then(module => {
    PhysicsCollider = module.PhysicsCollider;
});
...
export function RunColliderVisualSystem(ecosystem: GameEcosystem) {
    //Might not be compiled in (no physics engine)
    if (!PhysicsCollider) {
        return;
    }
