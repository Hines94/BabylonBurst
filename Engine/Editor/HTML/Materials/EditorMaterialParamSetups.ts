import {AsyncTextureSetupParameter,SetAsyncTextureSetupEditorCallback} from "@BabylonBurstClient/Materials/MaterialSetupParameter"
...
export function bindEditorMaterialParamSetupCallbacks() {
    SetAsyncTextureSetupEditorCallback(setupAsyncTexture);
}
