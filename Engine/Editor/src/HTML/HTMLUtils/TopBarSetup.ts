...
export function SetupAllTopBarOptions(
    ecosystem: GameEcosystem,
    buildOptions: Partial<EditorBuildOptions>,
    visOptions: Partial<EditorVisOptions>,
    debugOptions: Partial<EditorDebugOptions>,
) {
