...
cp ${build_dir}/Autogeneration/ClientTypings_autogenerated.ts $CLIENT_INSTALLATION_PATH/Autogenerated/${project_Name_Lower}_ServerTypings_autogenerated.ts || exit
