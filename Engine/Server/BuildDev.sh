...
cd build
if ! node Autogenerator.js "${CLIENT_INSTALLATION_PATH}" $project_Name; 
...
if [ -z "$no_wasm" ]; then
    ...
    cp ./${project_Name}_WASM_autogenerated.wasm "${CLIENT_INSTALLATION_PATH}/Autogenerated/${project_Name}_WASM_autogenerated.wasm"
    cp ./${project_Name}_WASM_autogenerated.js "${CLIENT_INSTALLATION_PATH}/Autogenerated/${project_Name}_WASM_autogenerated.js"
    cd "../../"
fi
