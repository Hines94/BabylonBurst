...
CLIENT_INSTALLATION_PATH="..\Client\src"
...
echo "Path to client installation : $(convert_windows_path_to_wsl "$CLIENT_INSTALLATION_PATH")"
wslClientInstallPath=$(convert_windows_path_to_wsl "$CLIENT_INSTALLATION_PATH")
...
cp ./.env "$build_dir/$server_build_dir"
cp ./.env "$build_dir/$wasm_build_dir"
...
cd build
if ! node Autogenerator.js "$wslClientInstallPath" $project_Name; 
...
if [ -z "$no_wasm" ]; then
  ...
  export EMSDK=/home/jhines/emsdk
  export EM_CONFIG=/home/jhines/emsdk/.emscripten
  cd "$build_dir/$wasm_build_dir"
  ...
  cp ./${project_Name}_WASM_autogenerated.wasm "$wslClientInstallPath/Autogenerated/${project_Name}_WASM_autogenerated.wasm"
    cp ./${project_Name}_WASM_autogenerated.js "$wslClientInstallPath/Autogenerated/${project_Name}_WASM_autogenerated.js"
  cd "../../"
fi
